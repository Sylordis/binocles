...
import org.github.sylordis.binocle.utils.MapUtils;
 ...
 *
 */
public class LegendConfigurationType implements Serializable {
	 ...
	 */
	public LegendConfigurationType(String name) {
		this(name, "");
	}
	 ...
	 */
	public LegendConfigurationType(String name, String description) {
	 ...
	 * @see #getID(LegendConfigurationType)
	 */
	public boolean is(LegendConfigurationType t) {
