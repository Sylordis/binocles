...
public abstract class CustomDialog<R> {
	...
	/**
	 * Confirm button of the dialog, automatically instantiated if {@link #confirmButtonText} is provided.
	 */
	...
	/**
	 * Text of the confirm button, defaults to standard OK otherwise, automatically configured if provided.
	 */
	 ...
	 * @param model
	 */
	public CustomDialog(String title, BinocleModel model) {
		this.title = title;
		this.model = model;
	}
